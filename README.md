...
* **[`/whitepaper`](whitepaper/):** The complete specification (v3.2). Contains mathematical proofs for Sybil-Resistance, the end of redistribution systems (Pensions/Education), and the full lifecycle theory.
